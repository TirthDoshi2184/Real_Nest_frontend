...
const FlatForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        formDataToSend.append('makaanFile', selectedFile);

        try {
            const response = await axios.post('http://localhost:3000/flat/insertflat', formDataToSend, {
                headers: {
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <Grid item xs={12}>
                            <Button type="submit" variant="contained" color="primary" disabled={loading}>
                                {loading ? <CircularProgress size={24} /> : 'Add Flat'}
                            </Button>
                        </Grid>
                </Grid>
            </form>
